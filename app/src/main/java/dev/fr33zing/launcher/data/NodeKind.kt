...
const val UNLABELED_NODE_TEXT = "<Blank>"
        ...
        when (this) {
            ...
            Directory -> {
                if (payload is DirectoryPayload) {
                    ...
                    if (payload.nodeId == ROOT_NODE_ID) {
                        RootDirectoryColor
                    } else if (collapsed && !ignoreState) {
                ...
                if (payload is DirectoryPayload) {
                    ...
                    if (payload.specialMode != null) {
                        if (collapsed && !ignoreState) {
                            ...
                            payload.specialMode!!.icon
                        }
                    } else {
                        if (collapsed && !ignoreState) Icons.Outlined.Folder else Icons.Filled.Folder
                    }
                } else {
                    Icons.Filled.Folder
                }
