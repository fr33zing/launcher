...
inline fun <reified T : Payload> Payload.cast(): T =
    if (this::class == T::class) this as T
    else throw UnexpectedPayloadClassException(T::class, this)

inline fun <reified T : Payload> Payload.castOrNull(): T? =
    if (this::class == T::class) this as T else null
